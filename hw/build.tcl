...
CONFIG.Flow_Control {NonBlocking}] [get_ips floating_point_0]
generate_target all [get_files ${proj_name}/${proj_name}.srcs/sources_1/ip/floating_point_0/floating_point_0.xci]

# Adding an Floating-Point IP (MUL)
create_ip -name floating_point -vendor xilinx.com -library ip -module_name floating_point_mul
set_property -dict [list \
CONFIG.A_Precision_Type {Single} \
CONFIG.Operation_Type {Multiply} \
CONFIG.Flow_Control {NonBlocking}] [get_ips floating_point_mul]
generate_target all [get_files ${proj_name}/${proj_name}.srcs/sources_1/ip/floating_point_mul/floating_point_mul.xci]

# Adding an Floating-Point IP (ADD)
create_ip -name floating_point -vendor xilinx.com -library ip -module_name floating_point_add
set_property -dict [list \
CONFIG.A_Precision_Type {Single} \
CONFIG.Operation_Type {Add_Subtract} \
CONFIG.Add_Sub_Value {Add} \
CONFIG.Flow_Control {NonBlocking}] [get_ips floating_point_add]
generate_target all [get_files ${proj_name}/${proj_name}.srcs/sources_1/ip/floating_point_add/floating_point_add.xci]
